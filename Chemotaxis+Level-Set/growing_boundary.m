...
[u,v] = initalize_two_blob(dom_x,dom_y,4,6,5,5); % initialize u and v

phi = initalize_phi_circle2D(dom_x,dom_y,5,5,3);
...
for i = 1:1000
    if mod(i,10) == 0
        ...
        contour(z, 'r', 'LineWidth', 10); colorbar; axis equal tight;
        hold on
